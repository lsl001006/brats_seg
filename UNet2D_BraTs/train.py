...
import pandas as pd
import unet
from UNet_asyndgan import UNet
...
def train(args, train_loader, model, criterion, optimizer, epoch, scheduler=None):
    ...
    wandb.log({'Train-loss': losses.avg,  'Train-iou':ious.avg})
...
def validate(args, val_loader, model, criterion):
    ...
    wandb.log({'Val-loss': losses.avg,  'Val-iou':ious.avg})
    return log
...
def main():
    ...
    wandb.init(project="Unet-asyndgan", config=args)
    ...
    # Data loading code
    img_paths = glob(r'/home/lsl/Research/brats_seg/dataset/trainImage/*')
    mask_paths = glob(r'/home/lsl/Research/brats_seg/dataset/trainMask/*')
